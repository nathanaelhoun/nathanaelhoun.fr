...
<head>
    ...
    <meta name="Description"
        content="Welcome to Nathanaël Houn, computer science enthousiast since when I was younger, and student in Besançon (France)." />
    <meta name="Keyword"
        content="Nathanaël Houn, student, computer science, Licence informatique, CMI, Cursus Master en Ingénierie, computer enthousiast" />
    ...
    <div id="page-wrapper">
                ...
                <div class="inner">
                    ...
                    <div class="content">
                        ...
                        <a href="http://sciences.univ-fcomte.fr/pages/fr/menu3795/formations/cmi-informatique-besancon-17938-15943.html"
                            class="special">The Computer Sciences <em>CMI</em> curriculum in Besançon</a>
                    </div>
                </div>
            </section>
        ...
        <section id="footer">
            <div class="inner">
                ...
                <p>If you are interested by my profile, or if you have any comments about this website, or if you want
                    to contact me for any other reason, feel free to use the form below.</p>
                ...
                <ul class="contact">
                    ...
                    <li class="fa-file"><a
                            href="Nathanaël%20Houn%20Étudiant%20en%20Informatique%20CV%20online%20version.pdf">My resume
                            (french)</a></li>
                </ul>
                <ul class="copyright">
