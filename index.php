							...
							<section id="WhoAmI" class="wrapper spotlight style1">
								<div class="inner">
									...
									<div class="content">
										...
										<p>Intéressé par l'informatique depuis tout petit, j'en ai fait une véritable passion depuis 2016. J'ai fait beaucoup d'expériences avec des cartes-mères et autres composants informatiques, causant parfois quelques dégâts mais apprenant de mes erreurs. J'ai aussi découvert, via Internet, la programmation et l'HTML, dans lesquels je passe plus de temps depuis 2018.</p>
