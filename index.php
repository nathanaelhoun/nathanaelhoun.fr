  ...
  <div id="page-wrapper">
        ...
        <div class="inner">
          ...
          <section class="features">
            <article>
              ...
              <a href="projects/drMario/index.html" class="special">Essayer DrMario</a>
            </article>
            <article>
              <a href="#projects" class="image"><img src="images/pang.webp"></a>
              <h3 class="major">Pang</h3>
              <p>Développé dans le cadre du Projet d'Initiation à l'Ingénierie Logicielle de 1<sup>ère</sup> année de Licence.
                <br /> Incarnez un Franc-Comtois qui veut éliminer les ballons à l'aide des objets de sa région. Inspiré du
                rétro-jeu Pang.</p>
              <a href="projects/pang/index.html" class="special">Jouer à Pang</a>
            </article>
            <article>
              <a href="#projects" class="image"><img src="images/discordbot.webp"></a>
              <h3 class="major">Bot Discord</h3>
              <p>Un robot pour Discord, qui m'a permis de découvrir le JavaScript et Heroku. Interagit avec notre groupe de classe.</p>
    ...
    <section id="footer">
      <div class="inner">
        ...
        <p>Si mon profil vous intéresse, si vous avez un conseil pour ce site, ou si vous souhaitez me contacter
          pour toute autre raison, sentez-vous libre d'utiliser le formulaire ci-dessous, il est prévu à cet
          effet.</p>
        ...
        <ul class="contact">
          ...
          <li class="fa-file"><a href="Nathanaël%20Houn%20Étudiant%20en%20Informatique%20CV%20online%20version.pdf">Mon
              CV</a></li>
        </ul>
        <ul class="copyright">
